...
exports.outputBaseBranch = void 0;
exports.outputBaseBranch = `server/absences/getCalendarJF.ts(145,55): error TS2345: Argument of type 'LastCnt' is not assignable to parameter of type 'SelectionPeriaDataCnt'.
...
server/reports/data/getDataEtatPaiements.ts(61,105): error TS2345: Argument of type 'Criteria' is not assignable to parameter of type 'Criteria'.
  Types of property 'sal_id_out' are incompatible.
    Type 'number[] | null | undefined' is not assignable to type 'number[] | undefined'.
server/reports/data/getDataEtatPaiements.ts(89,9): error TS2322: Type 'Criteria' is not assignable to type 'Omit<ReportCriteria, "name" | "outputType">'.
  Types of property 'sal_id_out' are incompatible.
    Type 'number[] | null | undefined' is not assignable to type 'number[] | undefined'.
