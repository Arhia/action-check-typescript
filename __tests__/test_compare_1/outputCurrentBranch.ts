export const output = `server/absences/getCalendarJF.ts(145,55): error TS2345: Argument of type 'LastCnt' is not assignable to parameter of type 'SelectionPeriaDataCnt'.
  ...
  server/api/CRUD/router.ts(63,35): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/update">, any, any, ParsedQs, Record<string, any>>'.
  ...
  server/api/absences/compteurs/services/calculateCpRestants.ts(57,21): error TS2345: Argument of type '{ cml_id: number; cml_unite: number; cml_code: string; cml_lib: string; val_annuelle: number; }' is not assignable to parameter of type 'Cumul'.
    Type '{ cml_id: number; cml_unite: number; cml_code: string; cml_lib: string; val_annuelle: number; }' is missing the following properties from type 'Cumul': val_bul, val_duree_contrat
  server/api/absences/services/createDetailsAbsence.ts(81,9): error TS2322: Type 'DataGtaWithPplaDesc | null' is not assignable to type 'DataGta | null | undefined'.
    Type 'DataGtaWithPplaDesc' is not assignable to type 'DataGta'.
  ...
  server/api/absences/services/createDetailsAbsence.ts(82,9): error TS2322: Type 'Pare | null' is not assignable to type 'ProfilRem | null'.
    Type 'Pare' is not assignable to type 'ProfilRem'.
  ...
  server/api/contrats/router.ts(62,36): error TS2345: Argument of type '{ semp_id: number; pad_id: number; }' is not assignable to parameter of type 'Readonly<Input>'.
    Type '{ semp_id: number; pad_id: number; }' is missing the following properties from type 'Readonly<Input>': ncnt_id, dpub_id, trem_id, rcdd_id, and 4 more.
  ...
  server/api/contrats/services/GetInfosCnt.ts(367,17): error TS2740: Type 'PpaCourante' is missing the following properties from type 'pay_periodepaye_ppa': ppa_libelle, ppa_numero_ordre, ppa_datereglement, lot_id, and 2 more.
  ...
  server/api/dads/router.ts(66,31): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/generateFile">, any, any, ParsedQs, Record<string, any>>'.
  server/api/dads/router.ts(66,70): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/generateFile">, any, any, ParsedQs, Record<string, any>>'.
  ...
  server/api/dads/router.ts(71,35): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/generateFile">, any, any, ParsedQs, Record<string, any>>'.
  server/api/dads/router.ts(71,74): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/generateFile">, any, any, ParsedQs, Record<string, any>>'.
  server/api/dads/router.ts(73,35): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/generateFile">, any, any, ParsedQs, Record<string, any>>'.
  server/api/dads/router.ts(73,74): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/generateFile">, any, any, ParsedQs, Record<string, any>>'.
  ...
  server/api/imports/services/dsn/dataModel.ts(219,5): error TS6133: 'audit' is declared but its value is never read.
  server/api/imports/services/dsn/dataModel.ts(249,22): error TS2345: Argument of type 'any' is not assignable to parameter of type 'never'.
  server/api/imports/services/dsn/dataModel.ts(254,21): error TS2345: Argument of type 'any' is not assignable to parameter of type 'never'.
  server/api/imports/services/dsn/dataModel.ts(259,22): error TS2345: Argument of type 'any' is not assignable to parameter of type 'never'.
  server/api/imports/services/dsn/dataModel.ts(264,22): error TS2345: Argument of type 'any' is not assignable to parameter of type 'never'.
  ...
  server/api/salaries/router.ts(33,31): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/create">, any, any, ParsedQs, Record<string, any>>'.
  server/api/salaries/router.ts(33,70): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/create">, any, any, ParsedQs, Record<string, any>>'.
  server/api/salaries/router.ts(39,55): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/create">, any, any, ParsedQs, Record<string, any>>'.
  server/api/salaries/router.ts(41,59): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/create">, any, any, ParsedQs, Record<string, any>>'.
  ...
  server/api/salaries/router.ts(58,81): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/create">, any, any, ParsedQs, Record<string, any>>'.
  server/api/salaries/router.ts(58,120): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/create">, any, any, ParsedQs, Record<string, any>>'.
  ...
  server/api/salaries/router.ts(71,54): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/verifyExistingNir">, any, any, ParsedQs, Record<string, any>>'.
  ...
  server/api/workflows/absences/router.ts(41,21): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/forceValidation">, any, any, ParsedQs, Record<string, any>>'.
  server/api/workflows/absences/router.ts(42,21): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/forceValidation">, any, any, ParsedQs, Record<string, any>>'.
  ...
  server/api/workflows/router.ts(64,21): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/currentAdresse">, any, any, ParsedQs, Record<string, any>>'.
  server/api/workflows/router.ts(65,21): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/currentAdresse">, any, any, ParsedQs, Record<string, any>>'.
  ...
  server/api/workflows/router.ts(79,35): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/changeAdress">, any, any, ParsedQs, Record<string, any>>'.
  ...
  server/api/workflows/router.ts(91,21): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/currentBanque">, any, any, ParsedQs, Record<string, any>>'.
  server/api/workflows/router.ts(92,21): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/currentBanque">, any, any, ParsedQs, Record<string, any>>'.
  ...
  server/api/workflows/router.ts(166,21): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/infosDemandesAdmins">, any, any, ParsedQs, Record<string, any>>'.
  server/api/workflows/router.ts(167,21): error TS2339: Property 'session' does not exist on type 'Request<RouteParameters<"/infosDemandesAdmins">, any, any, ParsedQs, Record<string, any>>'.
  ...
  server/app/appUws.ts(60,42): error TS2345: Argument of type '{ semp_id: STATUT_EMPLOI_FONCTION_PUBLIQUE; pad_id: number; }' is not assignable to parameter of type 'Readonly<Input>'.
    Type '{ semp_id: STATUT_EMPLOI_FONCTION_PUBLIQUE; pad_id: number; }' is missing the following properties from type 'Readonly<Input>': ncnt_id, dpub_id, trem_id, rcdd_id, and 4 more.
  ...
  server/app/middlewares/fileNormalizationMiddleware.ts(22,53): error TS2345: Argument of type 'File | undefined' is not assignable to parameter of type 'File'.
    Type 'undefined' is not assignable to type 'File'.
  server/app/routerApp.ts(29,13): error TS2339: Property 'arhRouteIsWhitelistedForAuth' does not exist on type 'Request<RouteParameters<"/*">, any, any, ParsedQs, Record<string, any>>'.
  ...
  server/graphql/workflows/infosForValidationAbsence/resolver.ts(42,17): error TS2322: Type '{ plhSemaine1: gta_planninghebdo_plh & { jours: number[]; }; ppla_desc: string; }' is not assignable to type 'DataGta'.
    The types of 'plhSemaine1.jours' are incompatible between these types.
      Type 'number[]' is not assignable to type 'Jph[]'.
        Type 'number' is not assignable to type 'Jph'.
  server/graphql/workflows/infosForValidationAbsence/resolver.ts(43,17): error TS2322: Type 'pay_paramprofprem_pare' is not assignable to type 'ProfilRem'.
    Types of property 'pare_quot_journ_coll_ref' are incompatible.
      Type 'pare_quot_journ_coll_ref' is not assignable to type 'number'.
        Type 'null' is not assignable to type 'number'.
  ...
  server/helpdesk/routerHelpdesk.ts(46,9): error TS2322: Type 'string | string[] | ParsedQs | ParsedQs[] | undefined' is not assignable to type 'string | undefined'.
    Type 'string[]' is not assignable to type 'string'.
  server/helpdesk/zendesk/authZendeskSSO.ts(4,10): error TS6133: 'NODE_ENV' is declared but its value is never read.
  ...
  server/payrollEngine/PayrollEngine.ts(313,35): error TS2345: Argument of type 'PoolClient' is not assignable to parameter of type 'DbClient'.
    Type 'PoolClient' is not assignable to type '{ begin: () => Promise<void>; commit: () => Promise<void>; rollback: () => Promise<void>; }'.
  server/payrollEngine/PayrollEngine.ts(344,9): error TS2322: Type 'RubSelectedCalc[]' is not assignable to type 'RubInCalc[]'.
  server/payrollEngine/PayrollEngine.ts(492,10): error TS2790: The operand of a 'delete' operator must be optional.
  server/payrollEngine/PayrollEngine.ts(500,18): error TS2345: Argument of type 'PoolClient' is not assignable to parameter of type 'DbClient'.
    Type 'PoolClient' is not assignable to type '{ begin: () => Promise<void>; commit: () => Promise<void>; rollback: () => Promise<void>; }'.
  server/payrollEngine/PayrollEngine.ts(522,39): error TS2345: Argument of type 'PoolClient' is not assignable to parameter of type 'DbClient'.
    Type 'PoolClient' is not assignable to type '{ begin: () => Promise<void>; commit: () => Promise<void>; rollback: () => Promise<void>; }'.
  ...
  server/payrollEngine/druMgr/getDRUValue_CNT.ts(30,37): error TS2345: Argument of type 'cnt_datefin_prevue' is not assignable to parameter of type 'string | Date'.
    Type 'null' is not assignable to type 'string | Date'.
  server/payrollEngine/druMgr/getDRUValue_CNT.ts(34,45): error TS2339: Property 'cnt_datefin_duree_minimale' does not exist on type 'CntInCalc'.
  ...
  server/payrollEngine/profiles/selectPpla.ts(200,34): error TS2345: Argument of type 'peria_id' is not assignable to parameter of type 'number'.
    Type 'null' is not assignable to type 'number'.
  server/payrollEngine/selectBulsToRecalculate.ts(597,5): error TS2322: Type 'string' is not assignable to type 'Date'.
  server/payrollEngine/selectBulsToRecalculate.ts(598,5): error TS2322: Type 'string' is not assignable to type 'cnt_fin_date'.
  server/payrollEngine/selectBulsToRecalculate.ts(638,5): error TS2322: Type 'string' is not assignable to type 'Date'.
  server/payrollEngine/selectBulsToRecalculate.ts(639,5): error TS2322: Type 'string' is not assignable to type 'Date'.
  server/payrollEngine/selectBulsToRecalculate.ts(640,5): error TS2322: Type 'string' is not assignable to type 'Date'.
  server/payrollEngine/selectBulsToRecalculate.ts(641,5): error TS2322: Type 'string' is not assignable to type 'Date'.
  ...
  server/reports/data/absences/getDataCp.ts(453,9): error TS2322: Type 'wfl_demande_wdm | never[] | null' is not assignable to type '(wfl_demande_wdm | null)[]'.
    Type 'null' is not assignable to type '(wfl_demande_wdm | null)[]'.
  server/reports/data/absences/getDataCp.ts(455,9): error TS2322: Type 'pay_absence_abs | never[]' is not assignable to type 'pay_absence_abs[]'.
    Type 'pay_absence_abs' is missing the following properties from type 'pay_absence_abs[]': length, pop, push, concat, and 28 more.
  server/reports/data/absences/getDataCp.ts(464,49): error TS2339: Property 'abs_datedebut' does not exist on type 'Object'.
  server/reports/data/absences/getDataCp.ts(465,47): error TS2339: Property 'abs_datefin' does not exist on type 'Object'.
  server/reports/data/absences/getDataCp.ts(466,53): error TS2339: Property 'abs_datedebut_commence_aprem' does not exist on type 'Object'.
  server/reports/data/absences/getDataCp.ts(467,50): error TS2339: Property 'abs_datefin_finit_matin' does not exist on type 'Object'.
  server/reports/data/absences/getDataCp.ts(468,21): error TS2739: Type 'gta_profilplanning_ppla' is missing the following properties from type 'DataGta': ppla_desc, plhSemaine1
  server/reports/data/absences/getDataCp.ts(469,36): error TS2339: Property 'profilRem' does not exist on type 'FinalRow'.
  server/reports/data/absences/getDataCp.ts(471,21): error TS2322: Type '"ouvrés"' is not assignable to type 'TypeMethode'.
  server/reports/data/absences/getDataCp.ts(472,45): error TS2339: Property 'absenceHeures' does not exist on type 'Object'.
  server/reports/data/absences/getDataCp.ts(485,34): error TS2339: Property 'tab_desc' does not exist on type 'Object'.
  server/reports/data/absences/getDataCp.ts(485,53): error TS2339: Property 'tab_lib' does not exist on type 'wfl_demande_wdm'.
  server/reports/data/absences/getDataCp.ts(495,17): error TS2339: Property 'abs_non_paie' does not exist on type 'FinalRow'.
  server/reports/data/absences/getDataCp.ts(499,59): error TS2345: Argument of type 'pay_absence_abs' is not assignable to parameter of type 'Abs'.
    Property 'tab_lib' is missing in type 'pay_absence_abs' but required in type 'Abs'.
  server/reports/data/absences/getDataCp.ts(499,68): error TS2339: Property 'dabs' does not exist on type 'pay_absence_abs'.
  server/reports/data/absences/getDataCp.ts(508,25): error TS2322: Type 'gta_profilplanning_ppla' is not assignable to type 'DataGta'.
  server/reports/data/absences/getDataCp.ts(509,40): error TS2339: Property 'profilRem' does not exist on type 'FinalRow'.
  server/reports/data/absences/getDataCp.ts(511,25): error TS2322: Type '"ouvrés"' is not assignable to type 'TypeMethode'.
  server/reports/data/absences/getDataCp.ts(529,17): error TS2339: Property 'abs_non_paie' does not exist on type 'FinalRow'.
  server/reports/data/absences/getDataCp.ts(532,53): error TS2339: Property 'abs_non_paie' does not exist on type 'FinalRow'.
  server/reports/data/absences/getDatesNonPaieFromAbs.spec.ts(30,26): error TS2345: Argument of type '{ abs_id: number; ptab_id: number; abs_datedebut: Date; abs_datedebut_commence_aprem: boolean; abs_datefin: Date; abs_datefin_finit_matin: boolean; }' is not assignable to parameter of type 'Abs'.
    Type '{ abs_id: number; ptab_id: number; abs_datedebut: Date; abs_datedebut_commence_aprem: boolean; abs_datefin: Date; abs_datefin_finit_matin: boolean; }' is missing the following properties from type 'Abs': uab_id, tab_lib
    ...
    Type '{ sal_desc: string; cnt_desc: string; affs_desc: string; uorg_desc: string; emp_desc: string; cnt_debut_date: Date; signature: string; heureDebutDesc: gta_jourtrav_jtravFields.jtrav_heure_debut; heureFinDesc: gta_jourtrav_jtravFields.jtrav_heure_fin; repasDesc: string | null; }' is not assignable to type 'Row'.
      Types of property 'heureDebutDesc' are incompatible.
        Type 'jtrav_heure_debut' is not assignable to type 'string'.
          Type 'null' is not assignable to type 'string'.
  server/reports/data/getDataEtatPaiements.ts(19,11): error TS2430: Interface 'Criteria' incorrectly extends interface 'ReportCriteria'.
    Types of property 'sal_id_out' are incompatible.
      Type 'number[] | null | undefined' is not assignable to type 'number[] | undefined'.
        Type 'null' is not assignable to type 'number[] | undefined'.
  server/reports/data/getDataEtatPaiements.ts(61,105): error TS2345: Argument of type 'Criteria' is not assignable to parameter of type 'Criteria'.
    Types of property 'sal_id_out' are incompatible.
      Type 'number[] | null | undefined' is not assignable to type 'number[] | undefined'.
  server/reports/data/getDataEtatPaiements.ts(89,9): error TS2322: Type 'Criteria' is not assignable to type 'Partial<ReportCriteria>'.
    Types of property 'sal_id_out' are incompatible.
      Type 'number[] | null | undefined' is not assignable to type 'number[] | undefined'.
  server/reports/data/getDataEtatPaiements.ts(363,44): error TS2345: Argument of type 'Criteria' is not assignable to parameter of type 'CriteriaForWhere'.
    Types of property 'sal_id_out' are incompatible.
      Type 'number[] | null | undefined' is not assignable to type 'number[] | undefined'.
  server/reports/data/getDataEtatPaiements.ts(418,44): error TS2339: Property 'is_positif' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(419,44): error TS2339: Property 'is_negatif' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(421,25): error TS2339: Property 'is_negatif' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(423,101): error TS2339: Property 'sal_id' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(425,114): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(425,139): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(428,41): error TS2339: Property 'sal_id' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(429,103): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(429,128): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(433,115): error TS2339: Property 'sal_id' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(433,150): error TS2339: Property 'mdp' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(435,121): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(435,146): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(438,41): error TS2339: Property 'sal_id' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(439,103): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(439,128): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(440,38): error TS2339: Property 'mdp' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(444,53): error TS2339: Property 'sal_nom_usage' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(444,82): error TS2339: Property 'sal_prenom' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(446,55): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(448,55): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(453,55): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(455,55): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(458,29): error TS2339: Property 'is_positif' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(459,105): error TS2339: Property 'sal_id' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(461,118): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(461,143): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(464,45): error TS2339: Property 'sal_id' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(465,107): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(465,132): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(469,119): error TS2339: Property 'sal_id' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(469,154): error TS2339: Property 'mdp' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(471,125): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(471,150): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(474,45): error TS2339: Property 'sal_id' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(475,107): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(475,132): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(476,42): error TS2339: Property 'mdp' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(480,104): error TS2339: Property 'sal_id' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(480,139): error TS2339: Property 'mdp' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(482,118): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(482,143): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(485,45): error TS2339: Property 'sal_id' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(486,107): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(486,132): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(487,42): error TS2339: Property 'mdp' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(491,65): error TS2339: Property 'mdp' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(494,54): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(496,54): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(499,53): error TS2339: Property 'mdp' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(502,105): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(502,130): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(505,53): error TS2339: Property 'mdp' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(510,40): error TS2339: Property 'is_zero' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(511,25): error TS2339: Property 'is_zero' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(512,94): error TS2339: Property 'sal_id' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(514,111): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(514,136): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(517,41): error TS2339: Property 'sal_id' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(518,103): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(518,128): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(522,108): error TS2339: Property 'sal_id' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(522,143): error TS2339: Property 'mdp' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(524,118): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(524,143): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(527,41): error TS2339: Property 'sal_id' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(528,103): error TS2339: Property 'mnt_retenu' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(528,128): error TS2339: Property 'net_a_payer' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(529,38): error TS2339: Property 'mdp' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(533,49): error TS2339: Property 'sal_nom_usage' does not exist on type 'DataRow'.
  server/reports/data/getDataEtatPaiements.ts(533,78): error TS2339: Property 'sal_prenom' does not exist on type 'DataRow'.
  ...
  server/reports/data/getDataShared.ts(95,42): error TS2339: Property 'cumul' does not exist on type 'TemplateConfig'.
  server/reports/data/getDataShared.ts(95,136): error TS2339: Property 'cumul' does not exist on type 'TemplateConfig'.
  server/reports/data/getDataShared.ts(97,5): error TS2322: Type 'Group[]' is not assignable to type 'GroupToDisplay[]'.
    Type 'Group' is not assignable to type 'GroupToDisplay'.
      Types of property 'sAlert' are incompatible.
        Type 'string | null | undefined' is not assignable to type 'string'.
          Type 'undefined' is not assignable to type 'string'.
  server/reports/data/getDataShared.ts(110,21): error TS2345: Argument of type 'DataToDisplay<object> | undefined' is not assignable to parameter of type 'DataToDisplay<DataRow> | PromiseLike<DataToDisplay<DataRow>>'.
  ...
  server/reports/data/shared/groupOnColNo.ts(87,13): error TS2322: Type 'string | number | boolean' is not assignable to type 'string | boolean | null'.
    Type 'number' is not assignable to type 'string | boolean | null'.
  server/reports/data/shared/groupOnColNo.ts(102,22): error TS2345: Argument of type 'string | number | null' is not assignable to parameter of type 'string'.
    Type 'null' is not assignable to type 'string'.
  server/reports/data/shared/groupOnColNo.ts(103,19): error TS2345: Argument of type 'string | number' is not assignable to parameter of type 'string'.
    Type 'number' is not assignable to type 'string'.
  server/reports/data/shared/groupOnColNo.ts(104,28): error TS2345: Argument of type 'string | number | null' is not assignable to parameter of type 'string'.
    Type 'null' is not assignable to type 'string'.
  server/reports/data/shared/groupOnColNo.ts(107,32): error TS2538: Type 'null' cannot be used as an index type.
  server/reports/data/shared/groupOnColNo.ts(110,23): error TS2345: Argument of type 'string | number | null' is not assignable to parameter of type 'string'.
    Type 'null' is not assignable to type 'string'.
  server/reports/data/shared/groupOnColNo.ts(111,12): error TS2538: Type 'null' cannot be used as an index type.
  server/reports/dataReportsMgr.ts(83,121): error TS2339: Property 'messages' does not exist on type 'ApiServerResponse<any>'.
  server/reports/dataReportsMgr.ts(90,34): error TS2339: Property 'messages' does not exist on type 'ApiServerResponse<any>'.
  server/reports/dataReportsMgr.ts(148,34): error TS2339: Property 'messages' does not exist on type 'ApiServerResponse<any>'.
  server/reports/dataReportsMgr.ts(187,40): error TS2339: Property 'currentPdosId' does not exist on type 'ReportUser'.
  server/reports/dataReportsMgr.ts(188,41): error TS2339: Property 'currentPdosId' does not exist on type 'ReportUser'.
  server/reports/dataReportsMgr.ts(189,42): error TS2339: Property 'currentPdosId' does not exist on type 'ReportUser'.
  server/reports/dataReportsMgr.ts(309,61): error TS2345: Argument of type 'ReportCriteria' is not assignable to parameter of type 'Criteria'.
    Types of property 'uorg_id' are incompatible.
      Type 'number[] | undefined' is not assignable to type 'number[] | null'.
        Type 'undefined' is not assignable to type 'number[] | null'.
  server/reports/dataReportsMgr.ts(357,58): error TS2345: Argument of type 'ReportCriteria' is not assignable to parameter of type 'Criteria'.
    Property 'displayDetailDemandes' is missing in type 'ReportCriteria' but required in type 'Criteria'.
  server/reports/dataReportsMgr.ts(365,56): error TS2345: Argument of type 'ReportCriteria' is not assignable to parameter of type 'CriteriaOD'.
    Types of property 'uorg_id' are incompatible.
      Type 'number[] | undefined' is not assignable to type 'number[]'.
        Type 'undefined' is not assignable to type 'number[]'.
  server/reports/dataReportsMgr.ts(419,57): error TS2345: Argument of type 'ReportCriteria' is not assignable to parameter of type 'Criteria'.
  ...
  server/reports/dataReportsMgr.ts(446,64): error TS2345: Argument of type 'ReportCriteria' is not assignable to parameter of type 'EtatPrepCriteria'.
    Property 'bul_id' is missing in type 'ReportCriteria' but required in type 'EtatPrepCriteria'.
  server/reports/dataReportsMgr.ts(475,75): error TS2345: Argument of type 'ReportCriteria' is not assignable to parameter of type 'Criteria'.
    Types of property 'dsnd_id' are incompatible.
      Type 'number | undefined' is not assignable to type 'number'.
        Type 'undefined' is not assignable to type 'number'.
  server/reports/dataReportsMgr.ts(481,13): error TS2322: Type '(criteria: Criteria) => Promise<DataGetterResponse<Data>>' is not assignable to type 'DataGetter | DataGetterAsync | null'.
      ...
      Types of parameters 'criteria' and 'criteria' are incompatible.
        Type 'ReportCriteria' is not assignable to type 'Criteria'.
          Types of property 'dsnd_id' are incompatible.
            Type 'number | undefined' is not assignable to type 'number'.
              Type 'undefined' is not assignable to type 'number'.
  server/reports/dataReportsMgr.ts(487,13): error TS2322: Type '(criteria: Criteria) => Promise<DataGetterResponse<Data>>' is not assignable to type 'DataGetter | DataGetterAsync | null'.
    Type '(criteria: Criteria) => Promise<DataGetterResponse<Data>>' is not assignable to type 'DataGetter'.
      Types of parameters 'criteria' and 'criteria' are incompatible.
        Type 'ReportCriteria' is not assignable to type 'Criteria'.
          Types of property 'dsnd_id' are incompatible.
            Type 'number | undefined' is not assignable to type 'number'.
              Type 'undefined' is not assignable to type 'number'.
  server/reports/dataReportsMgr.ts(493,13): error TS2322: Type '(criteria: Criteria) => Promise<DataGetterResponse<Data>>' is not assignable to type 'DataGetter | DataGetterAsync | null'.
    Type '(criteria: Criteria) => Promise<DataGetterResponse<Data>>' is not assignable to type 'DataGetter'.
      Types of parameters 'criteria' and 'criteria' are incompatible.
        Type 'ReportCriteria' is not assignable to type 'Criteria'.
          Types of property 'dsnd_id' are incompatible.
            Type 'number | undefined' is not assignable to type 'number'.
              Type 'undefined' is not assignable to type 'number'.
  server/reports/dataReportsMgr.ts(565,76): error TS2339: Property 'currentPdosId' does not exist on type 'ReportUser'.
  server/reports/dataReportsMgr.ts(571,13): error TS2322: Type '(criteria: Criteria) => Promise<DataGetterResponse<Data>>' is not assignable to type 'DataGetter | DataGetterAsync | null'.
    Type '(criteria: Criteria) => Promise<DataGetterResponse<Data>>' is not assignable to type 'DataGetter'.
      Types of parameters 'criteria' and 'criteria' are incompatible.
        Type 'ReportCriteria' is not assignable to type 'Criteria'.
          Types of property 'dsnd_id' are incompatible.
            Type 'number | undefined' is not assignable to type 'number'.
              Type 'undefined' is not assignable to type 'number'.
  server/reports/dataReportsMgr.ts(577,13): error TS2322: Type '(criteria: Criteria) => Promise<DataGetterResponse<Data>>' is not assignable to type 'DataGetter | DataGetterAsync | null'.
    Type '(criteria: Criteria) => Promise<DataGetterResponse<Data>>' is not assignable to type 'DataGetter'.
      Types of parameters 'criteria' and 'criteria' are incompatible.
        Type 'ReportCriteria' is not assignable to type 'Criteria'.
          Types of property 'rdsnId' are incompatible.
            Type 'number | undefined' is not assignable to type 'number'.
              Type 'undefined' is not assignable to type 'number'.
  server/reports/dataReportsMgr.ts(595,72): error TS2345: Argument of type 'ReportCriteria' is not assignable to parameter of type 'ValidationCriteria'.
    Property 'origineRubs' is missing in type 'ReportCriteria' but required in type 'ValidationCriteria'.
  server/reports/dataReportsMgr.ts(610,76): error TS2345: Argument of type 'ReportUser' is not assignable to parameter of type 'User'.
  ...
  server/reports/dataReportsMgr.ts(664,60): error TS2345: Argument of type 'ReportUser' is not assignable to parameter of type 'User'.
  server/reports/dataReportsMgr.ts(739,95): error TS2339: Property 'messages' does not exist on type 'ApiServerResponse<any>'.
  ...
  server/reports/handlebars/handlebarsHelpers.spec.ts(53,17): error TS6133: 'options' is declared but its value is never read.
  server/reports/handlebars/handlebarsHelpers.spec.ts(67,24): error TS2554: Expected 0 arguments, but got 3.
  server/reports/handlebars/handlebarsHelpers.spec.ts(72,24): error TS2554: Expected 0 arguments, but got 3.
  server/reports/handlebars/handlebarsHelpers.spec.ts(77,24): error TS2554: Expected 0 arguments, but got 3.
  server/reports/handlebars/handlebarsHelpers.spec.ts(82,24): error TS2554: Expected 0 arguments, but got 3.
  server/reports/handlebars/handlebarsHelpers.spec.ts(87,24): error TS2554: Expected 0 arguments, but got 3.
  server/reports/objectToTemplateArray.ts(29,9): error TS2322: Type '(TemplateHeaderWithValue | null)[]' is not assignable to type 'TemplateHeaderWithValue[]'.
  ...
  server/reports/objectToTemplateArray.ts(89,5): error TS2322: Type '(TemplateHeaderWithValue | null)[]' is not assignable to type 'TemplateHeaderWithValue[]'.
  ...
  server/reports/templateMgr.ts(221,13): error TS2322: Type 'REPORT_TYPE_OUTPUT.HTML | REPORT_TYPE_OUTPUT.CHROMEPDF | REPORT_TYPE_OUTPUT.EXCEL | REPORT_TYPE_OUTPUT.SEPA | REPORT_TYPE_OUTPUT.DATA | "chrome-pdf"' is not assignable to type 'REPORT_TYPE_OUTPUT'.
  server/reports/templateMgr.ts(237,17): error TS2322: Type 'REPORT_TYPE_OUTPUT.HTML | REPORT_TYPE_OUTPUT.CHROMEPDF | REPORT_TYPE_OUTPUT.EXCEL | REPORT_TYPE_OUTPUT.SEPA | REPORT_TYPE_OUTPUT.DATA | "chrome-pdf"' is not assignable to type 'REPORT_TYPE_OUTPUT'.
  server/reports/templateMgr.ts(406,28): error TS2345: Argument of type 'TemplateStoredConfig | undefined' is not assignable to parameter of type 'TemplateStoredConfig | PromiseLike<TemplateStoredConfig | null> | null'.
