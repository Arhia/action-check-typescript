export const outputBaseBranch = `server/absences/getCalendarJF.ts(145,55): error TS2345: Argument of type 'LastCnt' is not assignable to parameter of type 'SelectionPeriaDataCnt'.
